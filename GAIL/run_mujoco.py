...
def argsparser():
    ...
    parser.add_argument('--env_id', help='environment ID', default='Hopper-v2')#game
    parser.add_argument('--seed', help='RNG seed', type=int, default=0)#随机种子
    parser.add_argument('--expert_path', type=str, default='data/deterministic.trpo.Hopper.0.00.npz')#专家数据
    ...
    parser.add_argument('--pi_nn', type=str, choices=['mlp','lstm','gru','mlpgru'], default='mlpgru')
...
def main(args):
    ...
    if args.task == 'train':
        ...
        dataset = Mujoco_Dset(expert_path=args.expert_path, traj_limitation=args.traj_limitation, randomize = (args.pinn == "mlp"))
        train(env,
              args.seed,
              args.pi_nn,
              policy_fn,
