...
def learn(env, policy_func, reward_giver, expert_dataset, rank,
          ...
          callback=None, load_path = None, use_true_reward = False
          ):
    ...
    fvp = U.flatgrad(gvp, var_list, 0.5)
    ...
    while True:
        ...
        seg["lprobs"] = compute_path_probs(seg["ac"], seg["mean"], seg["logstd"])
        ...
        for ob_batch, ac_batch, lprobs_batch in dataset.iterbatches((ob, ac, lprobs),
            ...
            lprobs_expert = compute_path_probs(ac_expert, mean_expert, std_expert)
