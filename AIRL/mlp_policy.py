...
class MlpPolicy(object):
    ...
    def _init(self, ob_space, ac_space, hid_size, num_hid_layers, min_std = 1e-6):
        ...
        self.logstd = logstd = tf.get_variable(name="logstd", shape=[1, pdtype.param_shape()[0]//2], initializer=tf.zeros_initializer())
        ...
        self._act = U.function([stochastic, ob], [self.ac, self.mean, std_param_var, self.vpred])

    def act(self, stochastic, ob):
        ac1, mean1, logstd1, vpred1 = self._act(stochastic, ob[None])
